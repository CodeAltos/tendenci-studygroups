...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudyGroup.creator'
        db.alter_column(u'studygroups_studygroup', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'StudyGroup.allow_user_view'
        db.alter_column(u'studygroups_studygroup', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'StudyGroup.view_contact_form'
        db.alter_column(u'studygroups_studygroup', 'view_contact_form', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'StudyGroup.entity'
        db.alter_column(u'studygroups_studygroup', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['entities.Entity'], null=True))

        # Changing field 'StudyGroup.owner'
        db.alter_column(u'studygroups_studygroup', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'StudyGroup.allow_anonymous_view'
        db.alter_column(u'studygroups_studygroup', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'StudyGroup.status'
        db.alter_column(u'studygroups_studygroup', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'StudyGroup.syndicate'
        db.alter_column(u'studygroups_studygroup', 'syndicate', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'StudyGroup.allow_user_edit'
        db.alter_column(u'studygroups_studygroup', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'StudyGroup.allow_member_view'
        db.alter_column(u'studygroups_studygroup', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'StudyGroup.allow_member_edit'
        db.alter_column(u'studygroups_studygroup', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'StudyGroup.creator'
        db.alter_column(u'studygroups_studygroup', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'StudyGroup.allow_user_view'
        db.alter_column(u'studygroups_studygroup', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'StudyGroup.view_contact_form'
        db.alter_column(u'studygroups_studygroup', 'view_contact_form', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'StudyGroup.entity'
        db.alter_column(u'studygroups_studygroup', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entities.Entity']))

        # Changing field 'StudyGroup.owner'
        db.alter_column(u'studygroups_studygroup', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'StudyGroup.allow_anonymous_view'
        db.alter_column(u'studygroups_studygroup', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'StudyGroup.status'
        db.alter_column(u'studygroups_studygroup', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'StudyGroup.syndicate'
        db.alter_column(u'studygroups_studygroup', 'syndicate', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'StudyGroup.allow_user_edit'
        db.alter_column(u'studygroups_studygroup', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'StudyGroup.allow_member_view'
        db.alter_column(u'studygroups_studygroup', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'StudyGroup.allow_member_edit'
        db.alter_column(u'studygroups_studygroup', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'studygroups.officer': {
            'Meta': {'object_name': 'Officer'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'position': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['studygroups.Position']"}),
            'study_group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['studygroups.StudyGroup']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'studygroups.position': {
            'Meta': {'object_name': 'Position'},
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['user_groups.Group']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'studygroups.studygroup': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'studygroups_studygroup_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'design_notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'studygroups_studygroup_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'studygroups_studygroup_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
